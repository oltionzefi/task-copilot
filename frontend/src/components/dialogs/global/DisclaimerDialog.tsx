      ...
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-left space-y-4 pt-4">
            <p>
              Task Copilot runs AI coding agents with{' '}
            ...
            <p>
              Learn more at{' '}
              <a
                href="https://www.taskcopilot.com/docs/getting-started#safety-notice"
                target="_blank"
                rel="noopener noreferrer"
                className="text-blue-600 dark:text-blue-400 underline hover:no-underline"
              >
                https://www.taskcopilot.com/docs/getting-started#safety-notice
              </a>
            </p>
          </DialogDescription>
        </DialogHeader>
