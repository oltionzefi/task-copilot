...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Task Copilot for your coding agents
</Card>

<Card title="Task Copilot MCP Server" icon="plug" href="/integrations/task-copilot-mcp-server">
  Connect external MCP clients to Task Copilot's MCP server
</Card>
</CardGroup>
