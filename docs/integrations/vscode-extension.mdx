...
description: "Complete guide to using the Task Copilot extension with VSCode, Cursor, and Windsurf"
---

The Task Copilot VSCode extension brings task management directly into your IDE, providing seamless integration with logs, diffs, and process monitoring. This extension works with VSCode and popular forks including Cursor and Windsurf.
...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=bloop.task-copilot">
  Install the official Task Copilot extension for VSCode
</Card>

Alternatively, search for the extension ID in VSCode:
1. Open VSCode
2. Press `Ctrl+Shift+X` (Windows/Linux) or `Cmd+Shift+X` (macOS) to open Extensions
3. Search for `@id:bloop.task-copilot`
4. Click **Install**
</Tab>
...
<Card title="Open VSX Registry" icon="download" href="https://open-vsx.org/extension/bloop/task-copilot">
...
**Problem**: The Task Copilot extension doesn't appear in your IDE.

**Solutions**:
- Verify the extension is installed by searching `@id:bloop.task-copilot` in Extensions
...
<Tip>
**Workflow Optimization**: Always start tasks from the Task Copilot web interface before opening in your IDE to ensure proper context and worktree setup.
</Tip>
...
<Info>
The extension is designed to work with any VSCode-compatible editor. If you're using a different VSCode fork, try installing from Open VSX Registry using the extension ID `bloop.task-copilot`.
</Info>
