...
<Step title="Install Web Companion">
  ...
  <Info>
  **Recommended**: Use the "Install companion automatically" button in the Preview tab to have Task Copilot create a task that installs and configures the companion for you.
